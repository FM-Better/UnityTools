...
//         {
//             _editorCoroutine = EditorCoroutineUtility.StartCoroutineOwnerless(Cor_CreateBaseEditor());
//         }
//
...
//         {
//             var type = Assembly.GetAssembly(typeof(Editor))
//                 .GetType("UnityEditor.PolygonCollider2DEditor", false); // 根据反射获取基类Editor
...
//                                          (Vector2)spriteRenderer.bounds.center; // 下一个顶点
//
//                                 var tangent = p2 - p1;
//
